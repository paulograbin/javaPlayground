...
class MaximumAverageSubarrayTest {
    ...
    @Test
    void basic() {
        double maxAverage = max.findMaxAverage(new int[]{1, 12, -5, -6, 50, 3}, 4);

        Assertions.assertThat(maxAverage).isEqualTo(12.75);
    }

    @Test
    void notbasic() {
        double maxAverage = max.findMaxAverage(new int[]{
                8860, -853, 6534, 4477, -4589, 8646, -6155, -5577, -1656, -5779, -2619, -8604, -1358, -8009, 4983,
                7063, 3104, -1560, 4080, 2763, 5616, -2375, 2848, 1394, -7173, -5225, -8244, -809, 8025, -4072, -4391,
                -9579, 1407, 6700, 2421, -6685, 5481, -1732, -8892, -6645, 3077, 3287, -4149, 8701, -4393, -9070,
